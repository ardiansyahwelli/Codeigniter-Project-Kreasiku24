...
class Admin_model extends CI_Model{
	...
	public function addRole($data)
	{
		...
		message('New user account has been added!', 'success', 'admin/role');
	}

	public function deleteRole($id)
	{
		$this->db->delete('user_role',['id' => $id]);
		message('User account has been deleted!', 'success', 'admin/role');
	}

	public function editRole($data)
	{
		$this->db->update('user_role', $data, ['id' => $data['id']]);
		message('User account has been updated!', 'success', 'admin/role');
	}
